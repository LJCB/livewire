...
<html lang="en">
  <head>
    ...
    <style>
      .gradient {
        background: linear-gradient(80deg, #350C79 0%, #11817C 100%);
      }
    </style>
    @livewireStyles
  </head>
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
          <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
            <img src="{{ asset('images/logos/logo.png') }}" class="inline h-16 w-16" alt="">
          </a>
        </div>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Instituto</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Especialistas</a>
            </li>
            <li class="mr-3">
          ...
          @auth
            <a id="navAction" href="{{ url('/dashboard') }}" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">Dashboard</a>
          @else
            <a id="navAction" href="{{ route('login') }}" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">Ingresar</a>
          @endauth
      ...
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <p class="leading-normal text-2xl mb-8">
            Somos la primer institución certificadora en Salud Funcional en habla hispana donde desarrollamos tu potencial y transformamos a los profesionales de la salud para integrar todos los conocimientos de salud física, mental y espiritual.
          </p>
        ...
        <!--Right Col-->
        <div class="w-full md:w-3/6 py-6 flex justify-end">
          <img class="w-full md:w-4/5 z-50" src="{{ asset('images/illustrations/meditation.svg') }}" />
        </div>
      </div>
    </div>
