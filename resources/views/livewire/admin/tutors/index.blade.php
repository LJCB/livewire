<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tutores</span>
                    </div>
                </li>
            </ol>
        </nav>
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white shadow-md dark:bg-gray-800 sm:rounded-lg p-4 mb-4">
            <div>
                <h5 class="mr-3 font-semibold dark:text-white">Tutores</h5>
                <p class="text-gray-500 dark:text-gray-400">Listado de tutores registrados</p>
            </div>
