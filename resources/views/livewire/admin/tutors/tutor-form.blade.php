    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
            ...
            <div class=" text-black  dark:text-white underline pt-2" >
                <a href="{{ route('admin.tutors') }}">Regresar al listado</a>
            </div>
        </div>
        @endif
        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            <div>
                <form wire:submit.prevent="{{ $tutor ? 'update' : 'store' }}">
                    <div class="mb-6">
                        ...
                        <input type="text" wire:model='name'
                            ...
                            placeholder="Nombre del examen" value="{{ $tutor ? $tutor->name : '' }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" wire:model='email'
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Nombre del examen" value="{{ $tutor ? $tutor->email : '' }}">
        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400">Selecciona los cursos que el tutor atenderá</p>
            </div>
            <div class="py-6">
                @foreach($courses as $course)
                <label class="relative inline-flex items-center cursor-pointer mr-2">
                    <input type="checkbox" class="sr-only peer" wire:model="coursesSelected.{{ $course->id }}">
                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                    <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">{{  $course->title }}</span>
                  </label>
                @endforeach
            </div>
        </div>
