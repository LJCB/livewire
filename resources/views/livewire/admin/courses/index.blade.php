    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white shadow-md dark:bg-gray-800 sm:rounded-lg p-4 mb-4">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400">Listado de cursos registrados</p>
            </div>
                ...
                <tr
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('admin.course.classes', $course->id) }}">
                            <span
                                class="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">{{ $course->classes()->count() }}</span>
                            </a>
                    </td>
                    <td class="px-6 py-4">
                        {{ $course->tutors()->count() }}
                    ...
                    <td class="px-6 py-4">
                        ...
                        <button data-modal-target="popup-modal-{{ $course->id }}"
                            data-modal-toggle="popup-modal-{{ $course->id }}" type="button"
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estas
                                            seguro
                                            de eliminar <strong> {{$course->title}}</strong>?</h3>
                                        <button data-modal-hide="popup-modal-{{$course->id}}" type="button"
