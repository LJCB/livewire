            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="/dashboard" class="flex ml-2 md:mr-24">
                        ...
                        <img src="{{ asset('images/logos/logo.png') }}" class="h-8 mr-3" alt="Inicio" />
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">ISFMC</span>
                    </a>
                </div>
